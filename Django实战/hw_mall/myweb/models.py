...
class Users(models.Model):
    ...
    def dePosit(self):
        return {
            ...
            'address': self.address, 'phone': self.phone, 'code': self.code
        }
...
class Goods(models.Model):
    ...
    def dePosit(self):
        return {
            'id': self.id, 'goods': self.goods, 'picname': self.picname,
            'price': self.price, 'descr': self.descr, 'store': self.store,
            'm': 1
        }
